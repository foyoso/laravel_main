    ...
    <div class="row">
      <div class="col-lg-12 p0">
        <div class="listing_single_property_slider">
          <div class="item">
            <img class="img-fluid" src="/client/findhouse/images/property/lsslider1.jpg" alt="lsslider1.jpg">
          </div>
          <div class="item">
            <img class="img-fluid" src="/client/findhouse/images/property/lsslider2.jpg" alt="lsslider2.jpg">
          </div>
          <div class="item">
            <img class="img-fluid" src="/client/findhouse/images/property/lsslider3.jpg" alt="lsslider3.jpg">
          </div>
          <div class="item">
            <img class="img-fluid" src="/client/findhouse/images/property/lsslider1.jpg" alt="lsslider1.jpg">
          </div>
              ...
              <div class="property_video p0">
                <div class="thumb">
                  ...
                  <div class="overlay_icon">
                    <a href="#"><img class="map_img_icon" src="/client/findhouse/images/header-logo.png"
                    ...
                    <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                      <div class="card-body text-center">
                        <img class="img-fluid" src="/client/findhouse/images/resource/floor_plan.png"
                          alt="floor_plan.png">
                        <p>Plan description. Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy
              ...
              <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item">
                  <a class="nav-link" id="listing-tab" data-toggle="tab" href="#listing" role="tab"
                    aria-controls="listing" aria-selected="false">Virtual Tour</a>
                </li>
              </ul>
              <div class="tab-content" id="myTabContent2">
                <div class="tab-pane fade show active" id="description" role="tabpanel"
                  ...
                  <div class="property_video">
                    <div class="thumb">
                      <img class="pro_img img-fluid w100" src="/client/findhouse/images/background/7.jpg" alt="7.jpg">
                      <div class="overlay_icon">
                        <a class="video_popup_btn red popup-youtube popup-img"
                          href="https://www.youtube.com/watch?v=oqNZOOWF8qM"><span class="flaticon-play"></span></a>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="tab-pane fade row pl15 pl0-1199 pr15 pr0-1199" id="listing" role="tabpanel"
                  ...
                  <div class="property_video">
                    <div class="thumb">
                      ...
                      <div class="overlay_icon">
                        <a class="video_popup_btn red popup-youtube popup-img"
                          href="https://www.youtube.com/watch?v=Jrs5yji5bb0"><span class="flaticon-play"></span></a>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-lg-12">
            <div class="walkscore_area mt30">
              <h4 class="mb30">Walkscore <span class="float-right"><img
                    src="/client/findhouse/images/resource/wscore.png" alt="wscore.png"></span></h4>
          ...
          <div class="col-lg-12">
            <div class="application_statics shop_single_tab_content style3 mt30">
              <ul class="nav nav-tabs float-right fn-414" id="myTab" role="tablist">
                <li class="nav-item">
                  <a class="nav-link active" id="hourly-tab" data-toggle="tab" href="#hourly" role="tab"
              ...
              <div class="mbp_pagination_comments mt30">
                ...
                <div class="mbp_first media">
                  ...
                  <div class="media-body">
                    ...
                    <p class="mt10">Beautiful home, very picturesque and close to everything in jtree! A little warm for
                      a hot weekend, but would love to come back during the cooler seasons!</p>
                  </div>
                </div>
        ...
        <div class="sidebar_listing_list">
          <div class="sidebar_advanced_search_widget">
            <div class="sl_creator">
              ...
              <div class="media">
                <img class="mr-3" src="/client/findhouse/images/team/lc1.png" alt="lc1.png">
                <div class="media-body">
              ...
              <li class="search_area">
                <div class="form-group">
                  <textarea id="form_message" name="form_message" class="form-control required" rows="5"
                    required="required" placeholder="I'm interest in [ Listing Single ]"></textarea>
                </div>
              </li>
              <li>
        ...
        <div class="terms_condition_widget">
          ...
          <div class="sidebar_feature_property_slider">
            ...
            <div class="item">
              <div class="feat_property home7 agent">
                <div class="thumb">
                  <img class="img-whp" src="/client/findhouse/images/property/fp4.jpg" alt="fp4.jpg">
                  <div class="thmb_cntnt">
                    <ul class="tag mb0">
                      <li class="list-inline-item"><a href="#">For Rent</a></li>
                      <li class="list-inline-item"><a href="#">Featured</a></li>
            ...
            <div class="item">
              <div class="feat_property home7 agent">
                <div class="thumb">
                  <img class="img-whp" src="/client/findhouse/images/property/fp5.jpg" alt="fp5.jpg">
                  <div class="thmb_cntnt">
                    <ul class="tag mb0">
                      <li class="list-inline-item"><a href="#">For Rent</a></li>
                      <li class="list-inline-item"><a href="#">Featured</a></li>
