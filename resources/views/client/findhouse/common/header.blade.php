  ...
  <div class="container-fluid p0">
    ...
    <nav>
      ...
      <a href="#" class="navbar_brand float-left dn-smd">
        <img class="logo1 img-fluid" src="/client/findhouse/images/header-logo.png" alt="header-logo.png">
        <img class="logo2 img-fluid" src="/client/findhouse/images/header-logo2.png" alt="header-logo2.png">
        <span>FindHouse</span>
      </a>
