                ...
                <div class="email-rightbar mb-3">
                    <div class="card border border-danger">
                        ...
                        <div class="card-body">
                            ...
                            <form action="/admin/tagPortfolio/add" method="post" class="form-edit">
                                @csrf
                                <div class="row mb-3">
                                    <div class="col-sm-6">
                                        ...
                                        @if ($data)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <button onclick="removeRow(this,{{ $item->id  }},'{{ '/admin/tagPortfolio/delete'}}')" type="button" class="mb-1 mt-1 me-1 btn btn-xs btn-danger"><i class="fas fa-trash-alt"></i></button>
                                                </td>
                                            </tr>
                                            @endforeach
                                        @endif
...
@section('addJs')
<script>
    var linkAdd = '/admin/tagPortfolio/add';
    var linkEdit = '/admin/tagPortfolio/edit';
</script>
