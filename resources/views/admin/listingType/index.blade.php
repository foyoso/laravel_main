                ...
                <!-- Right Sidebar -->
                    ...
                    <div class="card border border-danger">
                        <div class="card-header bg-transparent border-danger">
                            ...
                            <a class="btn btn-success float-end" href="/admin/listingType/add/"> Add</a>
                        </div>
                        <div class="card-body">
                            @include('admin.common.alert')
                            <form action="/admin/listingType/add" method="post" class="form-edit">
                                @csrf
                                <div class="row mb-3">
                                    <div class="col-sm-6">
                                        ...
                                        @if ($data)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <button onclick="removeRow(this,{{ $item->id  }},'{{ '/admin/listingType/delete'}}')" type="button" class="mb-1 mt-1 me-1 btn btn-xs btn-danger"><i class="fas fa-trash-alt"></i></button>
                                                </td>
                                            </tr>
                                            @endforeach
                                        @endif
...
@section('addJs')
<script>
    var linkAdd = '/admin/listingType/add';
    var linkEdit = '/admin/listingType/edit';
</script>
<script src="/theme-admin/js/listing/type.js"></script>
@endsection