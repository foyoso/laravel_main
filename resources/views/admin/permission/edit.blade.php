        ...
        <div class="col-md-8">
            <div class="card border border-danger">
                ...
                <div class="card-body">
                    ...
                    <form action="/admin/permission/edit/{{$data -> id}}" method="POST">
                        @csrf
                        <div class="row form-group mb-4">
                            ...
                            <div class="col-sm-12">
                                ...
                                <select name="group_name" class="form-control">
                                   <option value="page" {{$data -> group_name == 'page'?'selected':''}}>Page</option>
                                   <option value="website" {{$data -> group_name == 'website'?'selected':''}}>Website</option>
                                   <option value="post" {{$data -> group_name == 'post'?'selected':''}}>Post</option>
                                </select>
                            </div>
                        </div>
