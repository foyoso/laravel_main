...
class PortfolioService
{
    ...
    public function getAllForSelectBox(){
        return Portfolio::select('id','name')->orderbyDesc('id')->get();
    }
    public function create($request, $website)
    {
        DB::beginTransaction();
        try {
            $listing = Portfolio::create([
    ...
    {
        return Portfolio::where('id', $id)->firstOrFail();
    }
    public function getArrayData() {
        $arr = array();
        $categories = Portfolio::orderbyDesc('id')->get();
