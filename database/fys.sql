...
INSERT INTO `admins` VALUES (1,'sys admin','admin@gmail.com',NULL,'$2y$10$FujfL3o7Wmhc4A79uoIpdutkr3D2FxmXf3x7ar7a3iQfnpCx4WRjG',NULL,NULL,NULL,NULL);
...
CREATE TABLE `layouts` (
  ...
  `link_demo` varchar(250) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `pages` (
  ...
  `banner_title` varchar(500) COLLATE utf8_unicode_ci DEFAULT NULL,
  `description` text COLLATE utf8_unicode_ci,
  `banner_description` varchar(500) COLLATE utf8_unicode_ci DEFAULT NULL,
  `keyword` text COLLATE utf8_unicode_ci,
  `slug` varchar(355) COLLATE utf8_unicode_ci NOT NULL,
  `og_image` varchar(355) COLLATE utf8_unicode_ci DEFAULT NULL,
  `page_default` tinyint(4) DEFAULT '0',
  `html_content` longtext COLLATE utf8_unicode_ci,
  `status` tinyint(4) NOT NULL DEFAULT '0',
  `review` int(11) DEFAULT '99',
  `rating` float DEFAULT '5',
  `is_home_page` tinyint(4) DEFAULT '0',
  `website_id` bigint(20) DEFAULT '0',
  `banner_type` tinyint(4) DEFAULT '0',
  `image_slider` text COLLATE utf8_unicode_ci,
  `image_banner` varchar(355) COLLATE utf8_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `users` VALUES (1,'admin','admin@gmail.com',NULL,'$2y$10$FujfL3o7Wmhc4A79uoIpdutkr3D2FxmXf3x7ar7a3iQfnpCx4WRjG',NULL,NULL,NULL,NULL);
...
-- Dump completed on 2023-03-09 15:28:12
